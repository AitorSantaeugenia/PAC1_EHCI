...
})({"8lzK8":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "876832fb81b84ccc";
"use strict";
...
},{}],"cvqAF":[function(require,module,exports) {
...
function readMorereadLess(paragraph) {
    ...
    if (paragraph === 0) {
        if (dots[0].style.display === "none") {
            ...
            btnText[0].innerHTML = "Leer m\xe1s";
        ...
        if (dots[1].style.display === "none") {
            ...
            btnText[1].innerHTML = "Leer m\xe1s";
        ...
        if (dots[2].style.display === "none") {
            ...
            btnText[2].innerHTML = "Leer m\xe1s";
        ...
        if (dots[3].style.display === "none") {
            ...
            btnText[3].innerHTML = "Leer m\xe1s";
        ...
        if (dots[4].style.display === "none") {
            ...
            btnText[4].innerHTML = "Leer m\xe1s";
        ...
        if (dots[5].style.display === "none") {
            ...
            btnText[5].innerHTML = "Leer m\xe1s";
        ...
        if (dots[6].style.display === "none") {
            ...
            btnText[6].innerHTML = "Leer m\xe1s";
        ...
        if (dots[7].style.display === "none") {
            ...
            btnText[7].innerHTML = "Leer m\xe1s";
        ...
        if (dots[8].style.display === "none") {
            ...
            btnText[8].innerHTML = "Leer m\xe1s";
    ...
    } else if (dots[9].style.display === "none") {
        dots[9].style.display = "inline";
        btnText[9].innerHTML = "Leer m\xe1s";
