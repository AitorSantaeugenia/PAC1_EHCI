...
function unhoverImage(element, elementType) {
    if (elementType === 1) element.setAttribute("src", "./src/assets/images/mindhunter_logo.svg");
    else if (elementType === 2) element.setAttribute("src", "./src/assets/images/mindhunter_logo.svg");
}
// FUNCTION TO HIDE THE MINDHUNTER POSTER AND SHOW THE TRAILER
function changeToVid(element) {
    element.classList.add("hidden");
    imagePoster.classList.add("hidden");
    trailerVideo.classList.remove("hidden");
    figCaption.innerHTML = `Tr\xe1iler oficial de Mindhunter. | Video proporcionado por <a href="https://www.youtube.com/watch?v=LR3G1lWbnUU" target="_blank">Netflix</a>`;
...
trailerVideo.addEventListener("ended", function() {
    ...
    figCaption.innerHTML = `P\xf3ster oficial de Mindhunter, temporada 2. | Imagen de <a href="https://www.rottentomatoes.com/tv/mindhunter/s02" target="_blank">Rotten Tomatoes</a>`;
